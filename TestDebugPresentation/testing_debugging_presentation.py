...
def function_name(input_name):
    ...
    :param input_name: This is a description of input to this function.
    :return: This is a description of the output of this function.
    """

    # Here we will have code that does whatever the function is supposed to do.
...
# pythonic - assertions
assert return_last_name('Taylor Swift') == 'Swift', 'WRONG for \'Taylor Swift\''
assert return_last_name('Madonna') == 'No last name', 'WRONG for \'Madonna\''
